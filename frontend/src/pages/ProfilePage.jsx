...
export const ProfilePage = () => {
    const {authUser,updateProfile,isUpdateProfile,checkAuth,isCheckingAuth} = useAuthStore();
...
console.log("Final image src:", selectedImg || authUser?.profilePic || "/avatar.png");
  return (
    <div className='h-screen pt-20'>
        <div className='max-w-2xl mx-auto px-4 p-4 py-8'>
